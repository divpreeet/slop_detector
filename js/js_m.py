...
# dataframe
df_path = os.path.join(root, 'dataset', 'js.csv')
...
numerics = ["num_l", "num_b", "comment_r", "avg_l_len", "indent_var", "num_funcs", "arrow_r", "avg_ind_len"]
text = "code"
...
joblib.dump(pipeline, 'models/js.pkl')